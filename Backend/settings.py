...
CORS_ALLOW_ALL_ORIGINS = True  # or CORS_ALLOWED_ORIGINS = [...]
...
connect(db= os.getenv('cycle_data'), host= os.getenv('host'))
...
EMERGENCY_PHONE = os.getenv("TWILIO_EMERGENCY_PHONE")  # contact to alert
